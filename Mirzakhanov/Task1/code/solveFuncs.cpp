...
bool SolveFuncs::Solve::Solve(std::vector<LinearEquation>& system, const double& norm) noexcept {
    ...
    const auto eliminateUnder = [&system](const size_t& n) {
        for (size_t i = n + 1; i < system.size(); ++i) {
