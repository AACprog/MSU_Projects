...
int main(int argc, char* argv[]) {
    ...
    auto isSolvable_Order = Solve::SolveFuncs::Solve(copyMatrix, MatrixNorm);
    if (!std::get<0>(isSolvable_Order)) {
    ...
    auto solution = Solve::Answer::GetAnswer(copyMatrix, std::get<1>(isSolvable_Order));
    printf("Matrix:\n");
