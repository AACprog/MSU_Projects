...
int main(int argc, char* argv[]) {
    ...
    if(!Solve::Solver::Jordan(system, MatrixNorm(matrix))) {
    ...
    std::vector<double> solution = Solve::Solution::GetAnswer(system, (size_t)n);
    ...
    auto r1r2 = answerVariation(matrix, system, solution);
